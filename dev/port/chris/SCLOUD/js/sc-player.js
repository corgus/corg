...
*   Custom Build by Corey Gravelle
*   Original Version Author: Matas Petrikas, matas@soundcloud.com
...
(function($) {
  ...
  var apiKey,
      ...
      updateTrackInfo = function($player, track) {
        ...
        $('.sc-info', $player).each(function(index) {
			$('.sc-title', $player).html(track.title);
  ...
  $.scPlayer = function(options, node) {
    var opts = $.extend({}, $.scPlayer.defaults, options),
		...
		$title = $('<div class="sc-title"><h3></h3></div>').appendTo($player),
