...
<head>
    ...
    <script>
		...
		function initialize() { 	// Initializing Map
			// find current window width and set zoom map accordingly (>1000px=3, >400px=2, <400px=1) */
			...
			jsonmap = new google.maps.Map(document.getElementById('map-canvas'), mapOptions);
			infoWindow = new google.maps.InfoWindow();
			
			// Set default styles for map:			
			var mapStyles = [
			  {
			...
			// Create a script tag and fill with map data from file
		...
		/*	// 	Function to show properties of clicked map feature - retained for debugging purposes
			//  Adapted from http://www.geocodezip.com/v3_GoogleEx_layer-kml_us_states_simpleA.html
			function pointInfo(ptClick) {
				function showProps(obj) { var result = "";
					for (var i in obj) { if (obj.hasOwnProperty(i)) { 
						result +=  "ptClick.featureData." + i + " = " + obj[i] + "\n"; } }
					return result; }
				var cProps = showProps(ptClick);
				clk = clk + 1;
				var ptContent = "Click ("+clk+")<br>"+cProps+"<br>description = ";
...
<body onload="initialize()">
	...
	<div class="top top2"><div id="info"><img src="img/company_icon_red.png"><img src="img/focus_icon_magenta.png"><img src="img/focuswatch_icon.png"><img src="img/watch_icon_indigo.png"><img src="img/meeting_icon_red.png"></div><!--button onclick="UpdateRSS()">update</button--></div>
